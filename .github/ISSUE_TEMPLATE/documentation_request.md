...
Which file or section needs updating? (e.g., `README.md`, installation guide, configuration reference, facade usage examples, CHANGELOG)
...
Explain who benefits and how (e.g., new adopters, upgraders from v2.x, contributors).
